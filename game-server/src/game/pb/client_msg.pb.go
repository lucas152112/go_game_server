...
It has these top-level messages:
	...
	MsgBuyCarRes
	PropsConfig
	MsgGetPropsConfigsRes
	MsgBuyPropsReq
	MsgBuyPropsRes
	LordVipGivenItem
	LordVipConfig
	MsgLordVipConfigsRes
	MsgLordVipUpgradedNotify
	MsgGetJinorshunReq
	MsgGetJinorshunRes
	MsgGetUserRechargeReq
	MsgGetUserRechargeRes
	LotteryBetUserDef
	MsgGetLotteryInfoReq
	MsgGetLotteryInfoRes
	MsgLotteryBetReq
	MsgLotteryBetRes
	MsgNotifyLotteryBetRes
	MsgGetLotteryPhaseReq
	MsgGetLotteryPhaseRes
	MsgGetLotteryHelpReq
	MsgGetLotteryHelpRes
	MsgNotifyLotteryAwardRes
	MsgNotifyLotteryStatusRes
	MsgEnterBairenDeskReq
	MsgEnterBairenDeskRes
	BairenOddsDef
	MsgGetBairenConfigReq
	MsgGetBairenConfigRes
	MsgGetBairenDeskInfoReq
	CardGroupDef
	MsgGetBairenDeskInfoRes
	MsgBairenBetReq
	MsgBairenBetRes
	MsgNotifyDeal
	MsgNotifyBet
	MsgNotifyOpen
	MsgBairenWaitBankerReq
	MsgBairenWaitBankerRes
	MsgGetbairenWaitBankerReq
	MsgGetbairenWaitBankerRes
	MsgNotifyChangeDealer
	MsgGetBairenUserReq
	MsgGetBairenUserRes
	IncomeTopDef
	MsgNotifysettlementRes
	MsgLeaveBairenPokerDeskReq
	WinLoseInfoDef
	MsgWinTrendReq
	MsgWinTrendRes
	MsgNotifyWaitBankerFail
	MsgBairenDownBankerReq
	MsgBairenDownBankerRes
	MsgGameHelpReq
	MsgGameHelpRes
	MsgBairenSwitchRes
	MsgNotifyLook
	MsgShoppinDiamodReq
	ShoppingDiamondDef
	MsgShoppingDiamondRes
	MsgShoppinGoldExgReq
	ShoppingGoldExgDef
	MsgShoppinGoldExgRes
	MsgShoppinquickReq
	ShoppingquickDef
	MsgShoppinquickRes
	MsgShoppingVIPReq
